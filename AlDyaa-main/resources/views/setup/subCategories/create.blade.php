    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('setups.sub.category.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('category') is-invalid @enderror" name="category" id="exampleSelectGender">
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}" {{ old('category') == $category->id ? 'selected' : '' }}>{{ $category->name_ar . '  ' . $category->name_en }}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="desc_ar" id="exampleTextarea1" rows="4" placeholder="Arabic Description"></textarea>

                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4">English Description</label>
                        <textarea class="form-control" name="desc_en" id="exampleTextarea1" rows="4" placeholder="English Description"></textarea>
                    </div>
                    <div class="form-group">
