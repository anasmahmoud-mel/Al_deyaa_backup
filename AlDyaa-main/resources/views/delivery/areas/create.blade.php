    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('delivery.areas.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('locality') is-invalid @enderror" name="locality" id="exampleSelectGender">
                            <option value="">---</option>
                            @foreach($localities as $locality)
                                <option value="{{ $locality->id }}" {{ old('locality') == $locality->id ? 'selected' : '' }}>{{ $locality->name_ar . ' | ' . $locality->name_en }}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        <div class="form-check form-check-primary">
                            <label class="form-check-label">
                                <input type="checkbox" name="has_delivery_price" class="form-check-input" value="1">
                                Has Delivery Price
                                <i class="input-helper"></i></label>
                        </div>
                    </div>
