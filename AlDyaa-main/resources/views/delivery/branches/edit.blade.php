    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('delivery.branches.update', $branch->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('city') is-invalid @enderror" name="city"
                            ...
                            @foreach($cities as $city)
                                <option
                                    value="{{ $city->id }}" {{ $branch->city_id == $city->id ? 'selected' : '' }}>{{ $city->name_ar . ' | ' . $city->name_en }}</option>
                            @endforeach
