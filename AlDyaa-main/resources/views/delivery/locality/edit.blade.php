    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('delivery.localities.update', $locality->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('city') is-invalid @enderror" name="city" id="exampleSelectGender">
                            ...
                            @foreach($cities as $city)
                                <option value="{{ $city->id }}" {{ $locality->city_id == $city->id ? 'selected' : '' }}>{{ $city->name_ar . ' | ' . $city->name_en }}</option>
                            @endforeach
